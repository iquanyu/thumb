...
use App\Orchid\Screens\Log\ActivityLogScreen;
...
Route::screen('student/{student?}', StudentEditScreen::class)
    ->name('platform.student.edit');

//活动日志相关
Route::screen('platform.systems.logs', ActivityLogScreen::class)
    ->name('platform.systems.logs');
